import 'package:current_core/src/current_cloneable.dart';
import 'package:current_core/src/current_exceptions.dart';

import 'current_state_view_model.dart';
...
///[CurrentStateViewModel.addStateChangedListener] function via the [propertyName] property on an [CurrentStateChanged] object.
///
...
class CurrentProperty<T> implements CurrentValue<T> {
  ...
  bool hasValueChanged(T currentValue, T originalValue) => currentValue != originalValue;

  CurrentStateViewModel? _viewModel;
  ...
  Iterable<CurrentViewModelBinding> get registeredBindings => List.unmodifiable(_registeredBindings);

  /// Returns the instance of the [CurrentStateViewModel] this
  /// property is associated with.
  ///
  CurrentStateViewModel get viewModel {
    if (_viewModel == null) {
      throw PropertyNotAssignedToCurrentViewModelException(StackTrace.current, propertyName, runtimeType);
    } else {
      return _viewModel!;
    }
  }

  CurrentProperty(this._value, {this.propertyName, this.isPrimitiveType = false}) {
  ...
  /// ```
  static CurrentProperty<TNullable?> nullable<TNullable>({String? propertyName}) {
  ...
  static CurrentIntProperty integer({int initialValue = 0, String? propertyName}) {
  ...
  /// ```
  static CurrentNullableIntProperty nullableInteger({int? initialValue, String? propertyName}) {
    return CurrentNullableIntProperty(value: initialValue, propertyName: propertyName);
  }
  ...
  /// ```
  static CurrentDoubleProperty doubleProp({double initialValue = 0.0, String? propertyName}) {
  ...
  /// ```
  static CurrentNullableDoubleProperty nullableDouble({double? initialValue, String? propertyName}) {
    return CurrentNullableDoubleProperty(value: initialValue, propertyName: propertyName);
  }

  static CurrentNullableDoubleProperty nullableDecimal({double? initialValue, String? propertyName}) {
    return CurrentNullableDoubleProperty(value: initialValue, propertyName: propertyName);
  }
  ...
  /// ```
  static CurrentStringProperty string({String initialValue = '', String? propertyName}) {
  ...
  /// ```
  static CurrentNullableStringProperty nullableString({String? initialValue, String? propertyName}) {
    return CurrentNullableStringProperty(value: initialValue, propertyName: propertyName);
  }
  ...
  /// ```
  static CurrentBoolProperty boolean({bool initialValue = false, String? propertyName}) {
  ...
  /// ```
  static CurrentNullableBoolProperty nullableBoolean({bool? initialValue, String? propertyName}) {
    return CurrentNullableBoolProperty(value: initialValue, propertyName: propertyName);
  }
  ...
  /// ```
  static CurrentDateTimeProperty dateTime({DateTime? initialValue, String? propertyName}) {
    return CurrentDateTimeProperty(initialValue ?? DateTime.now(), propertyName: propertyName);
  }
  ...
  /// ```
  static CurrentNullableDateTimeProperty nullableDateTime({DateTime? initialValue, String? propertyName}) {
    return CurrentNullableDateTimeProperty(value: initialValue, propertyName: propertyName);
  }
  ...
  /// ```
  static CurrentListProperty<TItem> list<TItem>({List<TItem>? initialValue, String? propertyName}) {
    return CurrentListProperty<TItem>(initialValue ?? <TItem>[], propertyName: propertyName);
  }
  ...
  static CurrentMapProperty<TKey, TValue> map<TKey, TValue>({
    ...
    return CurrentMapProperty<TKey, TValue>(initialValue ?? <TKey, TValue>{}, propertyName: propertyName);
  }

  ///Links this [CurrentProperty] instance with an [CurrentStateViewModel].
  void setViewModel(CurrentStateViewModel viewModel) {
  ...
  T set(T value, {bool notifyChange = true, bool setAsOriginal = false}) {
    ...
    if (notifyChange && previousValue != value) {
      viewModel.notifyChanges([
        CurrentStateChanged(value, previousValue, propertyName: propertyName, sourceHashCode: sourceHashCode),
      ]);
    }
