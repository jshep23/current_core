...
void main() {
  group('CurrentStateChanged Extension Tests', () {
    test('containsPropertyName - contains event matching property name - returns true', () {
      ...
      final events = [CurrentStateChanged('Bob', null, propertyName: propertyName)];
    ...
    test('firstForPropertyName - contains event matching property name - returns event', () {
      const String propertyName = 'name';
      final event = CurrentStateChanged('Bob', null, propertyName: propertyName);
      final events = [event];
    ...
    test('nextValueFor - contains event matching property name - returns nextValue', () {
      ...
      const String propertyName = 'name';
      final events = [CurrentStateChanged(nextValue, null, propertyName: propertyName)];
    ...
    test('previousValueFor - contains event matching property name - returns previousValue', () {
      ...
      const String propertyName = 'name';
      final events = [CurrentStateChanged(null, previousValue, propertyName: propertyName)];
